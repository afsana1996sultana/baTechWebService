            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('staff.store') }}" method="post" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            <label for="city">Name <small class="text-danger">*</small></label>
                                            <input id="name" type="text" name="name" value="{{ old('name') }}" data-parsley-trigger="change" required="" autocomplete="off" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            <label for="email">Email <small class="text-danger">*</small></label>
                                            <input id="email" type="email" name="email" value="{{ old('email') }}" data-parsley-trigger="change" required="" autocomplete="off" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            <label for="phone">Mobile Number <small class="text-danger">*</small></label>
                                            <input id="phone" type="text" name="phone" value="{{ old('phone') }}" data-parsley-trigger="change" required="" autocomplete="off" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            ...
                                            <input id="imageUpload" type="file" name="image" data-parsley-trigger="change" placeholder="" accept="application/image" autocomplete="off" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
