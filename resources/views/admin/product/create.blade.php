                ...
                <div class="col-xl-6 offset-xl-3 col-lg-10 offset-lg-1">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" float-left">Product Create</h5>
                            <a href="{{ route('product.index') }}" class=" btn btn-sm btn-primary float-right">Back</a>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('product.store') }}" method="post" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            ...
                                            <input id="model_no" type="text" name="model_no" value="{{ old('model_no') }}" required="" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            ...
                                            <input id="price" type="text" name="price" value="{{ old('price') }}" required="" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            ...
                                            <input id="qty" type="text" name="qty" value="{{ old('qty') }}" required="" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            ...
                                            <input id="warranty" type="text" name="warranty" value="{{ old('warranty') }}" required="" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            ...
                                            <input id="purchase_date" type="date" name="purchase_date" value="" data-parsley-trigger="change" required="" autocomplete="off" class="form-control">
                                        </div>
                                    </div>
